...
These files point to canonical templates elsewhere in the repo.

| Topic | Location |
|-------|----------|
| Client launch checklist | [`../CLIENT_LAUNCH_CHECKLIST.md`](../CLIENT_LAUNCH_CHECKLIST.md) |
| App Store / Play metadata worksheet | [`../STORE_METADATA_TEMPLATE.md`](../STORE_METADATA_TEMPLATE.md) |
| White-label build & EAS | [`../WHITE_LABEL_BUILDS.md`](../WHITE_LABEL_BUILDS.md) |
