...
**Phase 7C (RC tagging & retro):** [`RC_TAGGING_GUIDE.md`](./RC_TAGGING_GUIDE.md), [`PILOT_RETRO_TEMPLATE.md`](./PILOT_RETRO_TEMPLATE.md) — git tags for fixed baselines, structured pilot feedback.
